      ...
      <div className="firstt" >
        ...
        <div className="check1st">
          ...
          <div className="check2nd" >
            ...
            <h1 style={{textAlign:"start",fontSize:"13px"}}>JOIN OUR NEWSLETTER</h1>
          </div>
        ...
        <div className="footer">
          <ul className="smallscreen">
            ...
            <li> <Link>MY ZARA ACCOUNT</Link></li>
            <li> <Link>ITEMS AND SIZES</Link></li>
            <li> <Link>GIFT OPTIONS</Link></li>
            <li> <Link>SHIPPING</Link>e</li>
            <li> <Link>PAYMENT AND INVOICES</Link></li>

            <li> <Link>MY PURCHASES</Link></li>
            <li> <Link>EXCHANGES, RETURNS  AND REFUNDS</Link></li>
            <li> <Link>ZARA EXPERIENCIES</Link></li>
          </ul>

          <ul className="smallscreen">
            <p> <Link>FOLLOW US</Link></p>
          ...
          <ul className="smallscreen">
            ...
            <li><Link>JOIN LIFE</Link></li>
            <li><Link>OFFICES</Link></li>
          ...
          <ul className="smallscreen">
            <p><Link>POLICIES</Link></p>
            <li><Link>PRIVACY POLICY</Link></li>
            <li><Link>PURCHASE CONDITIONS</Link></li>
            <li><Link>GIFT CARD CONDITIONS</Link></li>
            <li><Link>COOKIES SETTINGS</Link></li>
        ...
        >
          ...
          >
            <p>NAME AND ADDRESS OF THE MANUFACTURER:
                <br />
   INDUSTRIA DE DISEÑO TEXTIL, S.A. (INDITEX, S.A.)
   <br />
   AVENIDA DE LA DIPUTACIÓN, EDIFICIO INDITEX, 15143, ARTEIXO (A CORUÑA), SPAIN</p>
          </div>
        </div>
      </div>
    </footer>
